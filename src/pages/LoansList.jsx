                        ...
                        return (
                            <Link to={`/loan/${loan.id}`} key={loan.id} className="loan-card">
                                <div className="loan-card-header">
                                    ...
                                    <span className={`status-badge ${(loan.amount - loan.amountPaid < 1) ? 'completed' : loan.status}`}>
                                        {(loan.amount - loan.amountPaid < 1) ? 'completed' : loan.status}
                                    </span>
                                </div>
                                ...
                                <div className="loan-footer">
                                    <div className="loan-meta">
                                        ...
                                        {loan.status === 'active' && (loan.amount - loan.amountPaid >= 1) && (
